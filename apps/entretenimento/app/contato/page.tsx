    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            <div className="mb-8">
                ...
                <p className="text-xl text-muted-foreground">Estamos aqui para ajudar</p>
            </div>
                ...
                <div className="bg-card border rounded-lg p-6">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">Tire dúvidas sobre nosso conteúdo.</p>
                        </div>
                        <div>
                            <h4 className="font-medium text-primary">Sugestões</h4>
                            <p className="text-sm text-muted-foreground">Sugestões de conteúdo são bem-vindas.</p>
                        </div>
                    </div>
                </div>
            </div>
